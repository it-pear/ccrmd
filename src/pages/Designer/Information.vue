...
<template>
  ...
  >
    <template v-slot:header>
      <div class="title">Работает с подрядчиками</div>
    </template>
    <div>
      <q-list
        v-if="props.partners.length"
  ...
  >
    <template v-slot:header>
      <div class="title">Условия работы с подрядчиками</div>
    </template>
